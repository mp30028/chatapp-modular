...
public class RecordsGeneratorTemplate2<B extends IRecordBuilder<T>,T> {
	//Defaults
	...
	public RecordsGeneratorTemplate2<B,T> minRecords(int minimumNumberOfRecords) {
		this.minimumNumberOfRecords = minimumNumberOfRecords;
		return this;
	}
	
	public RecordsGeneratorTemplate2<B, T> maxRecords(int maximumNumberOfRecords) {
